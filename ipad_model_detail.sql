...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 22, 2023 at 04:18 AM
...
--
-- Table structure for table `ipad_model_detail`
--

DROP TABLE IF EXISTS `ipad_model_detail`;
CREATE TABLE IF NOT EXISTS `ipad_model_detail` (
...
--
-- Dumping data for table `ipad_model_detail`
--

INSERT INTO `ipad_model_detail` (`sno`, `name`, `model`, `generation`, `model_number`, `yourpds`) VALUES
